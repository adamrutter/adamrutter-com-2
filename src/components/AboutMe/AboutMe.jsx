...
const AboutMe = () => {
  return (
    <Row className={classNames(styles.aboutMe)}>
      <Col lg={2}></Col>
      <Col lg={8}>
        <Row>
          <Col>
        ...
        <Row className={classNames("mt-4", "pt-3", "py-md-3")}>
          <Col>
            ...
            <p>
              ...
              most popular way to access the web, I think it’s important to
              start the design and development process focusing on them, and
              ensure the page adapts as the screen gets larger.
            </p>
            <p>
        ...
        <Row className={classNames("mt-md-4", "pb-3", "py-md-3")}>
          ...
          <Col md={9}>
            ...
            <p>
              Other technologies I've used but have less experience with
              include:
            </p>
            <ul>
              <li>React</li>
